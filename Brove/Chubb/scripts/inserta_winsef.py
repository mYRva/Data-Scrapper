    ...
    try:
        with connection.cursor() as cursor:
            ...
            sql = " INSERT INTO winsef (poliza, endoso, no_recibos, total_recibos, " \
                  ...
                  " moneda_descripcion) VALUES ('"+ poliza_ws + "', '" + str(endoso_ws) + "', '" + no_recibos + \
